...
public class VigenereAttack {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Length of guessed key: " + res.keyLen);
        System.out.println("Guessed key: " + res.key);
        System.out.println("Decrypted text(200): " + res.plaintext.substring(0, Math.min(200, res.plaintext.length())));
